...
import { getSellerItems, getSellerRestrictions, getItemsMulti, getUsersMulti, searchPublic, getDocs, } from '../controllers/mlSearchController.js';
 ...
 */
router.get('/seller-items/:sellerId', optionalAuthMiddleware, subscriptionActiveMiddleware, (req, res) => getSellerItems(req, res));
/**
 * GET /api/ml-search/seller-restrictions/:sellerId
 * Verificar restrições do vendedor
 * ⚠️ Se autenticado: verifica se assinatura está ativa
 */
router.get('/seller-restrictions/:sellerId', optionalAuthMiddleware, subscriptionActiveMiddleware, (req, res) => getSellerRestrictions(req, res));
/**
...
//# sourceMappingURL=mlSearchRoutes.js.map